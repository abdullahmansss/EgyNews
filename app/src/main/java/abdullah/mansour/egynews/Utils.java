...
public class Utils
{
    public static String title,imageurl;

    public static final String LOG_TAG = Utils.class.getSimpleName();

    public static List<NewsModel> fetchBooksData(String requestUrl) {
        // Create URL object
        ...
        List<NewsModel> book = extractFeatureFromJson(jsonResponse);
    ...
    private static List <NewsModel> extractFeatureFromJson(String booksJSON)
    {
        ...
        List<NewsModel> books = new ArrayList<>();
        // surround with try and catch
        try {
            // initialize baseJSONObject
            JSONObject baseJsonResponse = new JSONObject(booksJSON);
            // initialize JSONArray to get items array
            JSONArray itemsArray = baseJsonResponse.getJSONArray("articles");
            ...
            for (int i =0 ; i < itemsArray.length() ; i++)
            {
                ...
                books.add(new NewsModel(title,imageurl));
            }
